...
ALTER TABLE tipo_materia ADD institucion_id INT DEFAULT NULL;
ALTER TABLE tipo_materia ADD CONSTRAINT FK_7E097324B239FBC6 FOREIGN KEY (institucion_id) REFERENCES institucion (id);
CREATE INDEX IDX_7E097324B239FBC6 ON tipo_materia (institucion_id);

ALTER TABLE materia ADD descripcion VARCHAR(255) DEFAULT NULL;

ALTER TABLE alumno_materia CHANGE alumno_id alumno_id INT NOT NULL, CHANGE materia_id materia_id INT NOT NULL;

ALTER TABLE materia ADD establecimiento_id INT DEFAULT NULL;
ALTER TABLE materia ADD CONSTRAINT FK_6DF0528471B61351 FOREIGN KEY (establecimiento_id) REFERENCES establecimiento (id);
CREATE INDEX IDX_6DF0528471B61351 ON materia (establecimiento_id);
ALTER TABLE tipo_materia DROP FOREIGN KEY FK_7E097324B239FBC6;
DROP INDEX IDX_7E097324B239FBC6 ON tipo_materia;
ALTER TABLE tipo_materia CHANGE institucion_id establecimiento_id INT DEFAULT NULL;
