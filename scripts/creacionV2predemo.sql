...
CREATE TABLE `usuario` (
  ...
  KEY `FK_usuario_institucion_idx` (`institucion_id`),
  CONSTRAINT `FK_2265B05D90F1D76D` FOREIGN KEY (`rol_id`) REFERENCES `rol` (`id`),
  CONSTRAINT `FK_usuario_institucion` FOREIGN KEY (`institucion_id`) REFERENCES `institucion` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
-- Dump completed on 2015-07-22 18:38:46
