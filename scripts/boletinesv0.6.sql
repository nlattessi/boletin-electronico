...
CREATE TABLE `alumno` (
  ...
  `telefono_codigo_pais` varchar(3) COLLATE utf8_unicode_ci NOT NULL,
  `telefono_codigo_area` varchar(4) COLLATE utf8_unicode_ci NOT NULL,
  ...
  `foto` varchar(60) COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE `calificacion` (
  ...
  `comentario` varchar(127) COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE `convivencia` (
  ...
  `descargo` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE `docente` (
  ...
  `codio_area` varchar(4) COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE `establecimiento` (
  ...
  `codigo_pais` varchar(4) COLLATE utf8_unicode_ci DEFAULT NULL,
  `codigo_area` varchar(4) COLLATE utf8_unicode_ci DEFAULT NULL,
