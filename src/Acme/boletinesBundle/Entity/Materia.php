...
class Materia
{
     ...
     * Add horarios
     *
     * @param \Acme\boletinesBundle\Entity\MateriaDiaHorario $horarios
     * @return Materia
     */
    public function addHorario(\Acme\boletinesBundle\Entity\MateriaDiaHorario $horarios)
    {
     ...
     * @param \Acme\boletinesBundle\Entity\MateriaDiaHorario $horarios
     */
    public function removeHorario(\Acme\boletinesBundle\Entity\MateriaDiaHorario $horarios)
    {
     ...
     * Add evaluaciones
     *
     * @param \Acme\boletinesBundle\Entity\Evaluacion $evaluaciones
     * @return Materia
     */
    public function addEvaluacione(\Acme\boletinesBundle\Entity\Evaluacion $evaluaciones)
    {
        $this->evaluaciones[] = $evaluaciones;
     ...
     * @param \Acme\boletinesBundle\Entity\Evaluacion $evaluaciones
     */
    public function removeEvaluacione(\Acme\boletinesBundle\Entity\Evaluacion $evaluaciones)
    {
     ...
     * Add archivos
     *
     * @param \Acme\boletinesBundle\Entity\MateriaArchivo $archivos
     * @return Materia
     */
    public function addArchivo(\Acme\boletinesBundle\Entity\MateriaArchivo $archivos)
    {
        $this->archivos[] = $archivos;
     ...
     * @param \Acme\boletinesBundle\Entity\MateriaArchivo $archivos
     */
    public function removeArchivo(\Acme\boletinesBundle\Entity\MateriaArchivo $archivos)
    {
