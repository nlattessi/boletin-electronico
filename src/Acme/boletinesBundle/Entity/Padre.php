...
class Padre
{
     ...
     * @var string
     *
     * @ORM\Column(name="codio_area", type="string", length=4, nullable=true)
     */
    private $codioArea;
     ...
     * Set codioArea
     *
     * @param string $codioArea
     * @return Padre
     */
    public function setCodioArea($codioArea)
    {
        $this->codioArea = $codioArea;
     ...
     * @return string 
     */
    public function getCodioArea()
    {
        return $this->codioArea;
    }
